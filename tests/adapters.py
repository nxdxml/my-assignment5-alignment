...
from cs336_alignment.grpo_loss import *
from cs336_alignment.utils import *
from cs336_alignment.grpo_microbatch_train_step import grpo_microbatch_train_step

from cs336_alignment.evaluate_gsm8k_zero_shot import parse_gsm8k_response
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    """
    return masked_mean(tensor=tensor,
                       mask=mask,
                       dim=dim,
                       )
...
def run_masked_normalize(
    ...
    """
    return masked_normalize(tensor=tensor,
                            mask=mask,
                            dim=dim,
                            normalize_constant=normalize_constant)
